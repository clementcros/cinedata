					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<a href="<?= base_url('index.php/user/' . $user->username . '/delete') ?>" class="btn btn-danger btn-block btn-sm" onclick="return confirm('Are you sure you want to delete your account? If you click OK, your account will be immediatly and permanently deleted.')">Delete your account</a>
							</div>
						</div>	
					</div>
				</form>
