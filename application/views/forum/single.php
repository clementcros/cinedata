							...
							<tr>
								<td>
									<p>
										...
										<small>created by <a href="<?= base_url('index.php/user/' . $topic->author) ?>"><?= $topic->author ?></a>, <?= $topic->created_at ?></small>
									</p>
								</td>
								<td>
									<p>
								...
								<td class="hidden-xs">
									<p>
										<small>by <a href="<?= base_url('index.php/user/' . $topic->latest_post->author) ?>"><?= $topic->latest_post->author ?></a><br><?= $topic->latest_post->created_at ?></small></p>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
