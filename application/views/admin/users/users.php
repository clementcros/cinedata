	...
	<div class="row">
		<div class="col-md-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li role="presentation"><a href="<?= base_url('index.php/admin/forums_and_topics') ?>">Forums & topics</a></li>
				<li role="presentation"><a href="<?= base_url('index.php/admin/options') ?>">Options</a></li>
						...
						<tbody>
							<?php foreach ($users as $user) : ?>
								<tr>
									...
									<td><a class="btn btn-xs btn-primary" href="<?= base_url('index.php/admin/edit_user/' . $user->username) ?>">Edit</a> <a class="btn btn-xs btn-danger" href="<?= base_url('index.php/admin/delete_user/' . $user->username) ?>">Delete</a></td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
